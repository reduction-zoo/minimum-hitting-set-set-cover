...
Next action: execute round 001 and its independent checks.

| Round | Mechanism / scope | First check | Outcome | Evidence |
|---|---|---|---|---|
| 001 | Incidence transpose with exact-optimum recovery | Empty member and empty family, then all prepared optima | In progress | [round](rounds/001/round.md) |
